...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WalkingQuest.Droid.StepCounterService, WalkingQuest.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StepCounterService.class, __md_methods);
	}


	public StepCounterService () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StepCounterService.class)
			mono.android.TypeManager.Activate ("WalkingQuest.Droid.StepCounterService, WalkingQuest.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
